...
import DynamicMedicine from '../dynamicMedicine/DynamicMedicine'
...
export default function Sales() {
  ...
  const handleSubmit = (event) => {
    ...
    for (const [index, num] of entries.entries()) {
      ...
      saleItemCreateDtos.push(saleItemCreateDto)

      formData = {
        customerId: customerId,
        date: date,
        saleItemCreateDtos: saleItemCreateDtos,
      }
    }
    ...
    fetch('http://localhost:5422/sales', {
      method: 'POST',
      headers: {
