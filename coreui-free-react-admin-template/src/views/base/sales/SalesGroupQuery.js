...
export default function SalesGroupQuery() {
  ...
  function loadData() {
    ...
    fetch('http://localhost:5422/sales-group-query', {
      method: 'POST',
      headers: {
        ...
        {sales?.length > 0 && (
          <Card style={{ marginTop: '20px' }} title="Sorgu Sonucu (İlaç)">
            ...
            >
              ...
              <Column field="groupName" sortable header="İlaç Adı" />
